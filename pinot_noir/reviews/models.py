...
class Review(models.Model):
    ...
    STATUS_TEAM_APPROVED = "Team Approved"
    STATUS_COMMUNITY_APPROVED = "Community Approved"
    ...
    STATUS_CHOICES = [
        ...
        (STATUS_TEAM_APPROVED, STATUS_TEAM_APPROVED),
        (STATUS_COMMUNITY_APPROVED, STATUS_COMMUNITY_APPROVED),
